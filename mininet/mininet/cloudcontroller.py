...
class OnosLxcController (LxcController):
    def __init__(self, name,
        ...
        assert (('ip' in params) or (admin_ip is not None)
                ), "provide at least an ip or an admin_ip"
        ...
        super(OnosLxcController, self).__init__(name=name, loop=loop,
                                                admin_ip=admin_ip, master=master, image=image, **params)
...
class RyuLxcController (OnosLxcController):
    def __init__(self, name,
                 ...
                 **params):
        super(RyuLxcController, self).__init__(name=name, loop=loop,
                                               admin_ip=admin_ip, master=master, image=image, **params)

...
##        host_iface2 = self.params2.get("host_iface", None)
        ...
        node1.addContainerLink(target1=node1.target, target2=node2.target,
                               link_id=link_id, bridge1=interfaces[0], bridge2=interfaces[1], link=self)
        node2.addContainerLink(target1=node2.target, target2=node1.target,
                               link_id=link_id, bridge1=interfaces[1], bridge2=interfaces[0], link=self)
